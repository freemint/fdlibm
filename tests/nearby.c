...
static test_f_f_data const nearbyint_data[] = {
	...
	{ __LINE__, HEXCONSTE(-4.45015e-308, 0xbc02, 0x8000044dL, 0xb01f4deeL), ZERO_M, NO_INEXACT_EXCEPTION },

	/* Default rounding mode is round to nearest.  */
	{ __LINE__, HEXCONSTE(0.5, 0x3ffe, 0x80000000L, 0x00000000L), ZERO_P, NO_INEXACT_EXCEPTION },
	{ __LINE__, HEXCONSTE(1.5, 0x3fff, 0xc0000000L, 0x00000000L), HEXCONSTE(2.0, 0x4000, 0x80000000L, 0x00000000L), NO_INEXACT_EXCEPTION },
	{ __LINE__, HEXCONSTE(-0.5, 0xbffe, 0x80000000L, 0x00000000L), ZERO_M, NO_INEXACT_EXCEPTION },
