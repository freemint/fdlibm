...
static test_f_f_data const y0_data[] = {
	...
	{ __LINE__, HEXCONSTE(2.36072207283297986806e+22, 0x4049, 0x9ff80000L, 0x00000000L), HEXCONSTE(1.818984347516051243459467456433028748678e-12L, 0x3fd7, 0xffffd15dL, 0xc983090bL), FLAG_INEXACT },
