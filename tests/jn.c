...
static test_if_f_data const jn_data[] = {
	...
	{ __LINE__, 3, HEXCONSTE(2.4048255576957729L, 0x4000, 0x99e8a974L, 0xb8da003fL), HEXCONSTE(0.19899990535769083404042146764530813L, 0x3ffc, 0xcbc6a195L, 0xac6b1a49L), FLAG_INEXACT|FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM },
	{ __LINE__, 4, HEXCONSTE(2.4048255576957729L, 0x4000, 0x99e8a974L, 0xb8da003fL), HEXCONSTE(0.647466661641779720084932282551219891E-1L, 0x3ffb, 0x8499e66dL, 0x99f4e87dL), FLAG_INEXACT|FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM },
	{ __LINE__, 5, HEXCONSTE(2.4048255576957729L, 0x4000, 0x99e8a974L, 0xb8da003fL), HEXCONSTE(0.163892432048058525099230549946147698E-1L, 0x3ff9, 0x8642bbf2L, 0x4440245dL), FLAG_INEXACT|FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM },
	{ __LINE__, 6, HEXCONSTE(2.4048255576957729L, 0x4000, 0x99e8a974L, 0xb8da003fL), HEXCONSTE(0.34048184720278336646673682895929161E-2L, 0x3ff6, 0xdf235ffcL, 0x760bbb65L), FLAG_INEXACT|FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM },
	{ __LINE__, 7, HEXCONSTE(2.4048255576957729L, 0x4000, 0x99e8a974L, 0xb8da003fL), HEXCONSTE(0.60068836573295394221291569249883076E-3L, 0x3ff4, 0x9d77838bL, 0x2c2e4f57L), FLAG_INEXACT|FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM },
	{ __LINE__, 8, HEXCONSTE(2.4048255576957729L, 0x4000, 0x99e8a974L, 0xb8da003fL), HEXCONSTE(0.92165786705344923232879022467054148E-4L, 0x3ff1, 0xc1492145L, 0x4d000160L), FLAG_INEXACT|FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM },
	{ __LINE__, 9, HEXCONSTE(2.4048255576957729L, 0x4000, 0x99e8a974L, 0xb8da003fL), HEXCONSTE(0.12517270977961513005428966643852564E-4L, 0x3fee, 0xd20144fdL, 0x00b01a7fL), FLAG_INEXACT|FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM },
