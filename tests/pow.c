...
static test_ff_f_data const fpow_data[] = {
	...
	{ __LINE__,  QNAN_P, ZERO_P, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  QNAN_M, ZERO_P, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  QNAN_P, ZERO_M, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  QNAN_M, ZERO_M, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  ZERO_P, ZERO_P, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  ZERO_M, ZERO_P, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  ZERO_P, ZERO_M, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  ZERO_M, ZERO_M, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	...
	{ __LINE__,  HEXCONSTE(0.9L, 0x3ffe, 0xe6666666L, 0x66666666L), INF_P, ZERO_P, FLAG_FAIL_ARANYM }, /* inf treated as NaN? */
	{ __LINE__,  HEXCONSTE(1e-7L, 0x3fe7, 0xd6bf94d5L, 0xe57a42bcL), INF_P, ZERO_P, FLAG_FAIL_ARANYM }, /* inf treated as NaN? */
	{ __LINE__,  HEXCONSTE(-0.9L, 0xbffe, 0xe6666666L, 0x66666666L), INF_P, ZERO_P, FLAG_FAIL_ARANYM }, /* inf treated as NaN? */
	{ __LINE__,  HEXCONSTE(-1e-7L, 0xbfe7, 0xd6bf94d5L, 0xe57a42bcL), INF_P, ZERO_P, FLAG_FAIL_ARANYM }, /* inf treated as NaN? */
	...
	{ __LINE__,  INF_M, HEXCONSTE(-1, 0xbfff, 0x80000000L, 0x00000000L), ZERO_M, FLAG_FAIL_ARANYM }, /* returns +zero */
	...
	{ __LINE__,  HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), QNAN_P, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM }, /* returns NaN */
	{ __LINE__,  HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), QNAN_M, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM }, /* returns NaN */
	...
	{ __LINE__,  HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), INF_P, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM }, /* returns NaN */
	{ __LINE__,  HEXCONSTE(-1, 0xbfff, 0x80000000L, 0x00000000L), INF_P, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM }, /* returns NaN */
	{ __LINE__,  HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), INF_M, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM }, /* returns NaN */
	{ __LINE__,  HEXCONSTE(-1, 0xbfff, 0x80000000L, 0x00000000L), INF_M, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_SOFTFLOAT|FLAG_FAIL_ARANYM }, /* returns NaN */

	/*  pow (x, +-0) == 1.  */
	{ __LINE__,  INF_P, ZERO_P, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  INF_P, ZERO_M, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  INF_M, ZERO_P, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  INF_M, ZERO_M, HEXCONSTE(1, 0x3fff, 0x80000000L, 0x00000000L), FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	...
	{ __LINE__,  ZERO_P, INF_M, INF_P, FLAG_FAIL_ARANYM }, /* glibc returns NaN */
	{ __LINE__,  ZERO_M, INF_M, INF_P, FLAG_FAIL_ARANYM }, /* glibc returns NaN */
